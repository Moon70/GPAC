 ...
 * <br>A color quantizer, based on the 'Median Cut' algorithm.
 * <br>Before saving an image as GIF using Java API, use this API to reduce the colours to 256 to get a better image quality.
 * <br>Please note this is an early version.
...
public class GPAC_experimental {
	...
	private void replaceCubeColorsHash(Cube cube,int[] pixelcount1,int[] pixelcount2) {
